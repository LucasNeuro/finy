-- Script completo: criar tabelas quick_replies e quick_reply_queues (para rodar no SQL Editor
-- quando a tabela ainda não existir no banco, ex.: produção Supabase).
